var QuickSidebar = function () {
    var i = function () {
        ...
        }), i.find(".page-quick-sidebar-chat-user .").click(function () {
        ...
        //         }, n = new Date, c = s("out", n.getHours() + ":" + n.getMinutes(), "Bob Nilson 3", "avatar3", r);
        //         c = $(c), e.append(c), e.slimScroll({scrollTo: "1000000px"}), t.val(""), setTimeout(function () {
        //             var i = new Date,
        //                 a = s("in", i.getHours() + ":" + i.getMinutes(), "Ella Wong 2", "avatar2", "Lorem ipsum doloriam nibh...");
        //             a = $(a), e.append(a), e.slimScroll({scrollTo: "1000000px"})
        //         }, 3e3)
        //     }
        // };
        // a.find(".page-quick-sidebar-chat-user-form .btn").click(), a.find(".page-quick-sidebar-chat-user-form .form-control").keypress(function (i) {
