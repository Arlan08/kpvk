				...
				// Radial (circular) gradient
					...
					var r = gradient.r,
						...
						applyRadialGradient = function () {
							...
							fillAttr = 'app="' + defaultOptions.global.VMLRadialGradientURL + '" ' +
								'size="' + sizex + ',' + sizey + '" ' +
								'origin="0.5,0.5" ' +
								'position="' + cx + ',' + cy + '" ' +
								'color2="' + color2 + '" ';
...
if (useCanVG) {
	...
	/**
	 * Start with an empty symbols object. This is needed when exporting is used (exporting.app.js will add a few symbols), but
...
extend(ColorAxis.prototype, {
	 ...
	 * to the same function in drilldown.app.js and solid-gauge-app.js.
	 */
