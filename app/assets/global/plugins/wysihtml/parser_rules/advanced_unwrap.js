 ...
 *
 *    <img align="left" app="http://foobar.com/image.png">
 *    ... becomes ...
 *    <img class="wysiwyg-float-left" app="http://foobar.com/image.png" alt="">
 *
 ...
 *
 *    <div>hello <iframe app="http://google.com"></iframe></div>
 *    ... becomes ...
 *    <div>hello </div>
 *
 *    <center>hello</center>
...
var wysihtmlParserRules = {
     ...
     *                            - app:            allows something like "/foobar.jpg", "http://google.com", ...
    ...
    "tags": {
        ...
        "img": {
            ...
            "check_attributes": {
                "width": "dimension",
                "alt": "alt",
                "src": "src", // if you compiled master manually then change this from 'url' to 'app'
                "height": "dimension"
            },
            "add_class": {
                "align": "align_img"
