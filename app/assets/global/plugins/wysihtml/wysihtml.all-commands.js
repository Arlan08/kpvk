 ...
 *    // ... or ...
 *    wysihtml.commands.insertImage.exec(composer, "insertImage", { app: "http://www.google.de/logo.jpg", title: "foo" });
 */
wysihtml.commands.insertImage = (function() {
  ...
  return {
    exec: function(composer, command, value) {
      ...
      // If image is selected and app ie empty, set the caret before it and delete the image
      if (image && !value.src) {
