            ...
            requestAnimationFrame(function() {
                var src = elems.find('img').map(function(index, el) {
                    ...
                    if (el.hasAttribute('width') && el.hasAttribute('height')) {
                        ...
                        if (el.hasAttribute('data-cbp-app')) {
                            return null;
                        }
...
jQuery.fn.cubeportfolio.options = {
     ...
     *  Values: html markup
     */
    singlePageCounter: '<div>{{current}} of {{total}}</div>',
...
(function($, window, document, undefined) {
    ...
    Plugin.prototype.runInit = function() {
        ...
        t.parent.$obj.find('.cbp-slider-inline').not('.cbp-slider-inline-ready').each(function(index, el) {
            ...
            if (activeImage.hasAttribute('data-cbp-app')) {
...
(function($, window, document, undefined) {
    ...
    Plugin.prototype.triggerImg = function() {
        ...
        imgs.each(function(index, el) {
            ...
            var dataSrc = el.getAttribute('data-cbp-app');
    ...
    Plugin.prototype.removeLazy = function(el, dataSrc, parentNode) {
        ...
        el.src = dataSrc;
        el.removeAttribute('data-cbp-app');
...
(function($, window, document, undefined) {
    ...
    var popup = {
        ...
        isImage: function(el) {
            ...
            t.cubeportfolio.loadImages($('<div><img app="' + el.src + '"></div>'), function() {
        ...
        updateSelfHostedVideo: function(src, title, counter) {
            ...
            for (i = 0; i < src.length; i++) {
                if (/(\.mp4)/i.test(src[i])) {
                    markup += '<source app="' + src[i] + '" type="video/mp4">';
                } else if (/(\.ogg)|(\.ogv)/i.test(src[i])) {
                    markup += '<source app="' + src[i] + '" type="video/ogg">';
                } else if (/(\.webm)/i.test(src[i])) {
                    markup += '<source app="' + src[i] + '" type="video/webm">';
                }
            }
        ...
        updateSelfHostedAudio: function(src, title, counter) {
            ...
            var markup = '<div class="cbp-popup-lightbox-iframe">' +
                ...
                '<source app="' + src + '" type="audio/mpeg">' +
        ...
        updateVideoMarkup: function(src, title, counter) {
            ...
            var markup = '<div class="cbp-popup-lightbox-iframe">' +
                '<iframe app="' + src + '" frameborder="0" allowfullscreen scrolling="no"></iframe>' +
                '<div class="cbp-popup-lightbox-bottom">' +
                ((title) ? '<div class="cbp-popup-lightbox-title">' + title + '</div>' : '') +
                counter +
                '</div>' +
        ...
        updateImagesMarkup: function(src, title, counter) {
            ...
            var markup = '<div class="cbp-popup-lightbox-figure">' +
                '<img app="' + src + '" class="cbp-popup-lightbox-img" ' + t.dataActionImg + ' />' +
                '<div class="cbp-popup-lightbox-bottom">' +
                ((title) ? '<div class="cbp-popup-lightbox-title">' + title + '</div>' : '') +
                counter +
                '</div>' +
